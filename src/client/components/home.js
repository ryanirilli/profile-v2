  ...
  render() {
    ...
    return <div className="home-container">
      ...
      <section>
        ...
        <div className="o-wrapper u-padding-top-large u-padding-top@tablet">
          <div className="o-layout o-layout--center">
            <div className="o-layout__item u-1/2@desktop u-2/3@tablet u-1/1@mobile">
              <p className="u-text-center u-text-main">
                I have 8 years experience working from start ups to large companies in both design and engineering roles. I focus on bringing high quality user experiences to the production environment.
              </p>
            </div>
          </div>
        </div>
